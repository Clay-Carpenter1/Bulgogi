      ...
      <section className="relative h-[70vh] overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white z-20 px-4">
          <h1 className="text-7xl md:text-9xl font-black tracking-tight uppercase text-center leading-none [text-shadow:_4px_4px_8px_rgba(0,0,0,0.5)]">
            <div className="mb-4">Visit Us</div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-[#A9190F] flex items-center justify-center">
                        <FaMapMarkerAlt className="w-6 h-6 text-white" />
                      </div>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold mb-2 uppercase">Address</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 uppercase">Hours</h3>
                      <p className="text-gray-700 text-lg">
                        Monday - Saturday<br />
                        11:00 AM - 8:30 PM
                      </p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-gray-700 text-lg hover:text-[#A9190F] transition-colors"
                      >
                        (501) 358-5923
                      </a>
                    </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 uppercase">Parking</h3>
                      <p className="text-gray-700 text-lg">
          ...
          <div className="bg-white rounded-xl p-12 shadow-2xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                ...
                className="inline-block px-12 py-4 bg-white text-[#A9190F] text-xl font-bold rounded-lg border-2 border-[#A9190F] hover:bg-[#A9190F] hover:text-white transition-colors uppercase tracking-wide shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
              >
                Get Directions
              </a>
              <a
